            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card card-primary">
                        ...
                        <form id="delivery_area_create_form" method="POST" action="{{ route('delivery.area.update', ['id' => $delivery_area->delivery_area_id]) }}"
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('delivery_area_name') is-invalid @enderror" name="delivery_area_name" id="delivery_area_name" placeholder="Enter Delivery Area" value="{{ $delivery_area->delivery_area_name }}">
