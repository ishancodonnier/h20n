            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card card-primary">
                        ...
                        <form id="warehouse_create_form" method="POST" action="{{ route('warehouse.store') }}"
                            enctype="multipart/form-data">@csrf

                            <input type="hidden" name="warehouse_lat" id="warehouse_lat">
                            <input type="hidden" name="warehouse_lon" id="warehouse_lon">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('warehouse_name') is-invalid @enderror" name="warehouse_name" id="warehouse_name" placeholder="Enter Warehouse Name">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                name="warehouse_address_line1" id="warehouse_address_line1" placeholder="Enter Warehouse Address Line 1">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                name="warehouse_address_line2" id="warehouse_address_line2" placeholder="Enter Warehouse Address Line 2">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                name="warehouse_area" id="warehouse_area" placeholder="Enter Warehouse Area">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                name="warehouse_zip_code" id="warehouse_zip_code" placeholder="Enter Warehouse Zipcode">
