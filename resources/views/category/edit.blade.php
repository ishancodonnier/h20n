                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <form id="category_edit_form" method="POST"
                            action="{{ route('category.update', ['id' => $category->product_category_id]) }}" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                name="product_category_name" value="{{ $category->product_category_name }}" id="product_category_name" placeholder="Enter Category Name">
